...
public class CalcUtil {
	...
	public static void main(String[] args) {
		double totalPrice = 12.8;
		double postPrice = 10.0;
		double finalPrice = 12.8;
		double sumPrice = 12.8;
		
		System.out.println(CalcUtil.formatData(postPrice));
		
		double amount = CalcUtil.add(totalPrice,postPrice);
		System.out.println(amount);
		amount = CalcUtil.divide(finalPrice,amount);
		System.out.println(amount);
		amount = CalcUtil.multiply(amount,sumPrice);
		System.out.println(amount);
		System.out.println(amount);
		double a = CalcUtil.getPrice(amount);
