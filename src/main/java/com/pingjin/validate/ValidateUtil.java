...
public class ValidateUtil {
    ...
    private static final String PHONE_PATTERN = "^((13[0-9])|(14[0-9])|(19[0-9])|(17[0-9])|(15[^4,\\D])|(18[0-9]))\\d{8}$";
    ...
    public static boolean validate(String str, String pattern) {
        return StringUtil.hasText(str) && str.matches(pattern);
    }
