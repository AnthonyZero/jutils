...
public class SignUtil {
	 ...
	 * @throws IOException
	 */
	public static String getSignature(String secret, HashMap<String, String> params) throws IOException {
		// 先将参数以其参数名的字典序升序进行排序
		...
		for (Entry<String, String> param : entrys) {
			if (StringUtil.hasText(param.getValue())) {
	...
	public static String sign(String appKey, String secret, Map<String, String> paramMap)
    {
        ...
        {
        	if (StringUtil.hasText(paramMap.get(key))) {
        ...
        // MD5信息摘要 大写返回
        String sign = DigestUtils.md5Hex(codes.getBytes()).toUpperCase();
